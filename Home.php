    ...
    <div class="main">
        <div class="navbar">
            ...
            <div class="menu">
                <ul>
                        ...
                        <li><a href="shoppage.html">PRODUCTS</a></li>
        ...
        <div class="content">
            ...
            <p class="par">ᗩᒪᗯᗩƳᔕ ᗪᗴᒪIᐯᗴᖇ ᗰᗝᖇᗴ 丅ᕼᗩᑎ Ƴᗝᑌ ᗴ᙭ᑭᗴᑕ丅ᗴᗪ.</p>
                ...
                <div class="form">
				<form class="form1" name="myform" method="POST" action="login.php" onsubmit="validateform()">
                    <h2>Login Here</h2>
                    <input type="text" name="username" id="username" placeholder="Enter  Here">
                    <input type="password" name="password" id="password" placeholder="Enter Password Here" pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}" title="please provide a strong password with alphabet, numeric and symbol" required>
                    <button class="btnn"><a href="#">Login</a></button>
                    </form>
                    <p class="link">
                    <a href="RegisterPage.php">Sign up </a></p>
