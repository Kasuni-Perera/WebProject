           ...
           <!-- <div class="search">
                ...
                <div class="form"><br>
                        ...
                        <form method="post" action="register.php">
                            <input type="text" placeholder="Full Name" name="username" class="contact-in-input">
                            <input type="text" placeholder="Email" name="email" class="contact-in-input">
                            <input type="password" placeholder="password" name="password" class="contact-in-input"><br>
                            <button type="submit" value="SUBMIT" name="login_user" class="btnn">SUBMIT</button>
                        </form>
